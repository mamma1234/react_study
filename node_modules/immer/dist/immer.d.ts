...
import { ImmerState, IProduce, IProduceWithPatches, Objectish, PatchListener, Draft, Patch, Drafted } from "./types";
...
export declare class Immer implements ProducersFns {
    ...
    createProxy<T extends Objectish>(value: T, parent?: ImmerState): Drafted<T, ImmerState>;
    willFinalize(scope: ImmerScope, thing: any, isReplaced: boolean): void;
    markChanged(state: ImmerState): void;
}
export {};
